    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class=" col-md-4">
                    <h2>PiggyBankWTv2 Deposit From</h2>
                </div>
                
            </div>
            <div class="row">
                <div class="col-md-4 col-md-offset-2">
                    <form role="form" action="deposit.jsp">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="deposit" name="deposit"  placeholder="Please enter amount to be deposited">
                        </div>
